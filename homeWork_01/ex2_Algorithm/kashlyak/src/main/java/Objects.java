...
public class Objects {
    ...
    public void PC(){
        System.out.println("2. Компьютер стационарный");
        System.out.println("Состояние:");
    ...
    public void Headphones(){
        System.out.println("6. Наушникик.");
        System.out.println("Состояние:");
